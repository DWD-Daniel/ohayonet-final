    ...
    subcategories: [
      {
        ...
        products: [
          { id: 'ad-001', name: 'Diamicron 60mg 60tabs', price: '₦21,500', image: Diamicron6060, discount: '10% OFF' },
          { id: 'ad-002', name: 'Forziga 10mg', price: '₦16,500', image: Forziga10,},
          { id: 'ad-003', name: 'Galvus Met 50mg', price: '₦14,000', image: Galvusmet, discount: '10% OFF' },
          { id: 'ad-004', name: 'Jardiance 10mg', price: '₦18,500', image: Jardiance10 },
          { id: 'ad-005', name: 'Novomix Flexpen', price: '₦26,000', image: novomix },
          { id: 'ad-006', name: 'Diamicron 60mg 30tabs', price: '₦19,750', image: Diamicron60 },
        ],
      },
      {
        ...
        products: [
          { id: 'ah-001', name: 'Lisinopril 10mg', price: '₦14,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
          { id: 'ah-002', name: 'Metoprolol 50mg', price: '₦16,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', },
          { id: 'ah-003', name: 'Amlodipine 5mg', price: '₦18,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', },
          { id: 'ah-004', name: 'Losartan 100mg', price: '₦21,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
          { id: 'ah-005', name: 'Triplixam', price: '₦15,750', image: triplixam },
          { id: 'ah-006', name: 'Vastarel 5mg', price: '₦21,000', image: vastarel, isNew: true },
          { id: 'ah-007', name: 'Exforge 10mg/160mg', price: '₦35,000', image: Exforge, isNew: true },
          { id: 'ah-008', name: 'Atacand 16mg', price: '₦27,500', image: Atacand },
          { id: 'ah-009', name: 'Atacand Plus 16/12.5mg', price: '₦35,000', image: Atacandplus, discount: '8% OFF' },
        ],
      },
      {
        id: 'eye-ear-drops',
        ...
        products: [
          { id: 'eed-004', name: 'Ganfort', price: '₦30,000', image: Ganfort },
          { id: 'eed-005', name: 'Lumigan 2.5ml', price: '₦25,500', image: Lumigan, discount: '12% OFF' },
          { id: 'eed-006', name: 'Alphagan 5ml', price: '₦37,500', image: Alphagan, isNew: true },
          { id: 'eed-007', name: 'Xalatan', price: '₦34,500', image: 'https://images.unsplash.com/photo-1470162415307-7ed32bad0a5a?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
          { id: 'eed-008', name: 'Xalacom', price: '₦15,500', image: 'https://images.unsplash.com/photo-1470162415307-7ed32bad0a5a?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', discount: '5% OFF' },
        ],
      },
      {
        id: 'anti-pile',
        ...
        products: [
          { id: 'ap-001', name: 'Daflon 500mg', price: '₦22,750', image: Daflon500mg, isNew: true },
          ...
          { id: 'ap-004', name: 'Hemorrhoid Cream', price: '₦14,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', },
        ],
      },
      {
        id: 'blood-thinners',
        ...
        products: [
          ...
          { id: 'bt-004', name: 'Xarelto 10mg', price: '₦28,500', image: Xarelto10 },
          { id: 'bt-005', name: 'Xarelto 15mg', price: '₦35.99', image: Xarelto15 },
          { id: 'bt-006', name: 'Xarelto 20mg', price: '₦95,000', image: Xarelto20, discount: '12% OFF' },
        ],
      },
      {
        id: 'cough-cold-flu',
        ...
        products: [
          { id: 'ccf-001', name: 'Infacol Colic Relief', price: '₦17,000', image: infacol, discount: '18% OFF' },
...

      {
        ...
        products: [
          { id: 'aa-001', name: 'Ventolin 2.5mg', price: '₦12,500', image: ventolin, isNew: true },
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1615485276219-cbdf9309be1a?q=80&w=756&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        products: [
          { id: 'oab-001', name: 'Betmiga', price: '₦81,500', image: Betmiga50, isNew: true },
          { id: 'oab-002', name: 'Vesicare', price: '₦42,000', image: vesicare, discount: '10% OFF' },
        ],
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1615485276219-cbdf9309be1a?q=80&w=756&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        products: [
          { id: 'imm-001', name: 'Prograf', price: '₦40,000', image: Prograf, isNew: true },
        ],
      },
      {
        id: 'anti-androgen',
        ...
        image: 'https://images.unsplash.com/photo-1615485276219-cbdf9309be1a?q=80&w=756&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        products: [
          { id: 'aan-001', name: 'Casodex', price: '₦150,000', image: Casodex, discount: '5% OFF' },
        ],
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1685485276219-cbdf9309be1a?q=80&w=756&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        products: [
          { id: 'cca-001', name: 'Novorapid', price: '₦30,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', isNew: true },
          { id: 'cca-002', name: 'Apidra', price: '₦32,500', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
          { id: 'cca-003', name: 'Lantus', price: '₦75,000', image: 'https://images.unsplash.com/photo-1631549916768-4c192d749b23?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', discount: '8% OFF' },
        ],
      },
    ],
  },
